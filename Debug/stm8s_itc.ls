 ...
 422                     ; 101 ITC_PriorityLevel_TypeDef ITC_GetSoftwarePriority(ITC_Irq_TypeDef IrqNum)
 422                     ; 102 {
 423                     	switch	.text
 ...
 431                     ; 104     uint8_t Value = 0;
 433  002b 0f02          	clr	(OFST+0,sp)
 434                     ; 105     uint8_t Mask = 0;
 436  002d 7b01          	ld	a,(OFST-1,sp)
 437  002f 97            	ld	xl,a
 438                     ; 108     assert_param(IS_ITC_IRQ_OK((uint8_t)IrqNum));
 440                     ; 111     Mask = (uint8_t)(0x03U << (((uint8_t)IrqNum % 4U) * 2U));
 ...
 470  0051               L14:
 471                     ; 115     case ITC_IRQ_TLI: /* TLI software priority can be read but has no meaning */
 471                     ; 116     case ITC_IRQ_AWU:
 471                     ; 117     case ITC_IRQ_CLK:
 471                     ; 118     case ITC_IRQ_PORTA:
 471                     ; 119         Value = (uint8_t)(ITC->ISPR1 & Mask); /* Read software priority */
 ...
 479  005a               L34:
 480                     ; 121     case ITC_IRQ_PORTB:
 480                     ; 122     case ITC_IRQ_PORTC:
 480                     ; 123     case ITC_IRQ_PORTD:
 480                     ; 124     case ITC_IRQ_PORTE:
 480                     ; 125         Value = (uint8_t)(ITC->ISPR2 & Mask); /* Read software priority */
 ...
 488  0063               L54:
 489                     ; 136     case ITC_IRQ_SPI:
 489                     ; 137     case ITC_IRQ_TIM1_OVF:
 489                     ; 138         Value = (uint8_t)(ITC->ISPR3 & Mask); /* Read software priority */
 ...
 497  006c               L74:
 498                     ; 140     case ITC_IRQ_TIM1_CAPCOM:
 498                     ; 141 #ifdef STM8S903
 498                     ; 142     case ITC_IRQ_TIM5_OVFTRI:
 498                     ; 143     case ITC_IRQ_TIM5_CAPCOM:
 498                     ; 144 #else
 498                     ; 145     case ITC_IRQ_TIM2_OVF:
 498                     ; 146     case ITC_IRQ_TIM2_CAPCOM:
 498                     ; 147 #endif /*STM8S903*/
 498                     ; 148 
 498                     ; 149     case ITC_IRQ_TIM3_OVF:
 498                     ; 150         Value = (uint8_t)(ITC->ISPR4 & Mask); /* Read software priority */
 ...
 506  0075               L15:
 507                     ; 152     case ITC_IRQ_TIM3_CAPCOM:
 507                     ; 153     case ITC_IRQ_UART1_TX:
 507                     ; 154     case ITC_IRQ_UART1_RX:
 507                     ; 155     case ITC_IRQ_I2C:
 507                     ; 156         Value = (uint8_t)(ITC->ISPR5 & Mask); /* Read software priority */
 ...
 515  007e               L35:
 516                     ; 172     case ITC_IRQ_ADC1:
 516                     ; 173 #endif /*STM8S105, STM8S103 or STM8S905 or STM8AF626x */
 516                     ; 174 
 516                     ; 175 #ifdef STM8S903
 516                     ; 176     case ITC_IRQ_TIM6_OVFTRI:
 516                     ; 177 #else
 516                     ; 178     case ITC_IRQ_TIM4_OVF:
 516                     ; 179 #endif /*STM8S903*/
 516                     ; 180         Value = (uint8_t)(ITC->ISPR6 & Mask); /* Read software priority */
 ...
 533                     ; 186         break;
 535  008e               L302:
 536                     ; 189     Value >>= (uint8_t)(((uint8_t)IrqNum % 4u) * 2u);
 ...
 552                     ; 191     return((ITC_PriorityLevel_TypeDef)Value);
 ...
 649                     ; 208 void ITC_SetSoftwarePriority(ITC_Irq_TypeDef IrqNum, ITC_PriorityLevel_TypeDef PriorityValue)
 649                     ; 209 {
 650                     	switch	.text
 ...
 658                     ; 211     uint8_t Mask = 0;
 660  00a7 7b01          	ld	a,(OFST-1,sp)
 661  00a9 97            	ld	xl,a
 662                     ; 212     uint8_t NewPriority = 0;
 664  00aa 7b02          	ld	a,(OFST+0,sp)
 665  00ac 97            	ld	xl,a
 666                     ; 215     assert_param(IS_ITC_IRQ_OK((uint8_t)IrqNum));
 668                     ; 216     assert_param(IS_ITC_PRIORITY_OK(PriorityValue));
 670                     ; 219     assert_param(IS_ITC_INTERRUPTS_DISABLED);
 672                     ; 223     Mask = (uint8_t)(~(uint8_t)(0x03U << (((uint8_t)IrqNum % 4U) * 2U)));
 ...
 689                     ; 226     NewPriority = (uint8_t)((uint8_t)(PriorityValue) << (((uint8_t)IrqNum % 4U) * 2U));
